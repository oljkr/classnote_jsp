...
<%
	try{
		...
		String to     =request.getParameter("to").trim(); //받는사람
		String from   =request.getParameter("from").trim(); //보내는 사람
		String subject=request.getParameter("subject").trim(); //메일 제목
		String content=request.getParameter("content").trim(); //메일 내용
		...
		content+="<tr>";
		content+="	  <td>운동화</td>";
		content+="	  <td><span sytle='color:red; font-weight: bold;'>15,000원</span></td>";
		content+="</tr>";
		content+="</table>";
		
		content+="<hr>";
		content+="<img src='http://localhost:9090/myweb/images/song.jpg'>";
