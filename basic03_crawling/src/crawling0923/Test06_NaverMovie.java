...
public class Test06_NaverMovie {
	...
	public static void main(String[] args) {
		...
		try {
			...
			/*
			 * // 1. 평점 제목이 있는 요소 // <span id="_filtered_ment_0"> </span> // ... // <span
			...
			// 2. 평점 제목이 있는 요소
			/*
			 * <div class="score_reple"> <p> <span class="ico_viewer">관람객</span> <span
			 * id="_filtered_ment_0"> 현빈 다니엘 헤니 존잘ㅎㅎ </span> </p> </div>
			 */
